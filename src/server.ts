...
// ==========================================
// 1. Extend Express Request for TypeScript
// ==========================================
...
const useDb = async (req: CustomRequest, _res: Response, next: NextFunction) => {
  try {
...
// Get All Users
app.get("/api/users", useDb, async (req: CustomRequest, res: Response) => {
  try {
...
// Update User Role
app.patch("/api/users/:id/role", useDb, async (req: CustomRequest, res: Response) => {
  try {
    const { id } = req.params;
    const { role } = req.body;
...
// Update User Status
app.patch("/api/users/:id/status", useDb, async (req: CustomRequest, res: Response) => {
  try {
    const { id } = req.params;
...
// Admin Dashboard API
// ===========================
app.get("/api/admin/dashboard/stats", useDb, async (req: CustomRequest, res: Response) => {
  try {
    ...
    const totalRevenue = paidBookings.reduce(
      (total: number, booking: any) => total + Number(booking.totalPrice || 0),
      0
    );
...
app.get("/api/spaces", useDb, async (req: CustomRequest, res: Response) => {
  try {
    const {
      search = "",
      category,
...
app.get("/api/spaces/featured", useDb, async (req: CustomRequest, res: Response) => {
  try {
    const spaces = await req.spacesCollection!
      .find()
      .sort({ rating: -1 })
...
app.get("/api/spaces/:id", useDb, async (req: CustomRequest, res: Response) => {
  try {
    const { id } = req.params;
...
app.get("/api/spaces/related/:id", useDb, async (req: CustomRequest, res: Response) => {
  try {
    const { id } = req.params;
...
app.post("/api/spaces", useDb, async (req: CustomRequest, res: Response) => {
  try {
    const newSpace = {
      ...req.body,
      rating: 0,
...
// Users Stats API
// ===========================
app.get("/api/stats", useDb, async (req: CustomRequest, res: Response) => {
  try {
...
app.get("/api/bookings/user/:userId", useDb, async (req: CustomRequest, res: Response) => {
  try {
...
app.get("/api/bookings/:id", useDb, async (req: CustomRequest, res: Response) => {
  try {
    const { id } = req.params;
...
app.get("/api/user/bookings/statistics/:userId", useDb, async (req: CustomRequest, res: Response) => {
  try {
    const { userId } = req.params;
    ...
    const totalSpent = bookings
      ...
      .reduce((total: number, booking: any) => total + Number(booking.totalPrice || 0), 0);
...
app.post("/api/bookings", useDb, async (req: CustomRequest, res: Response) => {
  try {
    const booking = {
      ...req.body,
...
app.patch("/api/bookings/:id/cancel", useDb, async (req: CustomRequest, res: Response) => {
  try {
    const { id } = req.params;
    const booking = await req.bookingsCollection!.findOne({
      _id: new ObjectId(`${id}`),
...
app.delete("/api/bookings/:id", useDb, async (req: CustomRequest, res: Response) => {
  try {
    const { id } = req.params;
    const booking = await req.bookingsCollection!.findOne({
      _id: new ObjectId(`${id}`),
...
app.post("/api/create-checkout-session", useDb, async (req: CustomRequest, res: Response) => {
  try {
